use wasmer_runtime_core::{
    backend::CompilerConfig, backend::Features, compile_with_config, error::RuntimeError, imports,
    memory::Memory, typed_func::Func, types::MemoryDescriptor, units::Pages, vm, Instance,
};
